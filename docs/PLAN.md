...
- [~] P0-E11a The 19-step walkthrough exists as the baseline prototype's built-in "Run 19-step demo"; transcribe it into a written script once DXG confirms the flow
