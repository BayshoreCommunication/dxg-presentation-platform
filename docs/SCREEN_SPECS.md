...
- The editor shows every mapped field of that row with its current value, marks the missing ones, and refuses to save while any of them is still empty.
