/**
 * Light / dark theme (D-082).
 * Copied from the control center (D-084): the portal is a separate origin, so its choice
 * is remembered separately. The choice is per browser — "light", "dark" or "system" —
